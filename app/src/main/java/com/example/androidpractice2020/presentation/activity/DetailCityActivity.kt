...
class DetailCityActivity : MvpAppCompatActivity(), DetailCityView {
    ...
    private fun loadCityWeather(city: City) {
        ...
        city_temp.text = city.temp.toString() + " ℃"
        city_description.text = city.description
        city_icon_geo.setImageResource(R.drawable.ic_geo_foreground)
        number_humidity.text = "Влажность: ${city.numbHumidity} %"

        when (city.deg.toDouble()) {
    ...
    override fun showCityWeather(city: City) {
